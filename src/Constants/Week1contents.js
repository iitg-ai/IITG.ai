export const Week1contents = [
  {
    text: "Day 1",
    message: "",
  },
  {
    text: "<p>Getting Started with Python (Setup + Introduction to Python)</p><br/><p>Setting up a Python development environment with Anaconda and learning the basics of Jupyter Notebook for interactive programming. Introduction to the Python language for machine learning.</p>",
    message: "",
  },
  {
  ...
  },
  {
    ...
    <br><br>
    Covers the basic data structures required to get started with machine learning.
    `,
    message: "",
  },
  {
  ...
  },
  {
    text: `Numpy
    <br><br>
    Introduction to Numpy, the scientific computing library of Python. This will help you in doing heavy mathematical calculations
    `,
    message: "",
  },
  {
  ...
  },
  {
    text: `Pandas
    <br><br>
    Introduces pandas, a python package built on numpy which is most commonly used to handle tabular data and provides several tools that
...
`,
  ...
  },
  {
    ...
    Ignore 1.2 Plotting for Analysis
    `,
  },
  {
    text: `
  ...
  {
    text: "Covers Object Oriented Programming and tools to visualize data in form of charts and heatmaps.",
    message: "",
  },
  {
    text: `
